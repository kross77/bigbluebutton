...
<%
	Boolean isWrongPassword = request.getParameter("error").equals("wrong password");
	if (request.getParameterMap().isEmpty() || isWrongPassword) {
		//
...
">
	...
	<FORM NAME="form1" METHOD="GET" onsubmit="setCookie('patient', document.getElementById('patient').value);">
		<table cellpadding="5" cellspacing="5" style="width: 400px; ">
			...
			<tr>
				...
				<td style="width: 5px; ">
					&nbsp;</td>
				<td style="text-align: left ">
					<input type="text" id="patient" autofocus required name="patient" /></td>
			</tr>
			<tr>
				<td>
					&nbsp;</td>
...
<%
	...
	String joinURL = getJoinURL(request.getParameter("username"), request.getParameter("password"), "Vitaax Meeting", "false", null, null, null);
